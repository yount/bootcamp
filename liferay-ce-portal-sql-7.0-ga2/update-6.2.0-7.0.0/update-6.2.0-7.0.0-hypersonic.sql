alter table BlogsEntry add subtitle longvarchar null;
alter table BlogsEntry add coverImageCaption longvarchar null;
alter table BlogsEntry add coverImageFileEntryId bigint;
alter table BlogsEntry add coverImageURL longvarchar null;
...
alter table DLFolder add restrictionType int;
...
alter table ResourcePermission add viewActionId bit;
...
alter table UserNotificationEvent add deliveryType int;
alter table UserNotificationEvent add actionRequired bit;
