...
alter table BookmarksEntry add statusDate datetime null;
...
alter table BookmarksFolder add statusDate datetime null;
...
alter table LayoutPrototype add createDate datetime null;
alter table LayoutPrototype add modifiedDate datetime null;
...
alter table MBCategory add statusDate datetime null;
...
alter table MBDiscussion add createDate datetime null;
alter table MBDiscussion add modifiedDate datetime null;
...
alter table MBThread add createDate datetime null;
alter table MBThread add modifiedDate datetime null;
...
alter table MBThreadFlag add createDate datetime null;
...
alter table Organization_ add createDate datetime null;
alter table Organization_ add modifiedDate datetime null;
...
alter table PollsChoice add createDate datetime null;
alter table PollsChoice add modifiedDate datetime null;
...
alter table RepositoryEntry add createDate datetime null;
alter table RepositoryEntry add modifiedDate datetime null;
...
alter table Role_ add createDate datetime null;
alter table Role_ add modifiedDate datetime null;
...
alter table UserGroup add createDate datetime null;
alter table UserGroup add modifiedDate datetime null;
